...
<link rel="apple-touch-icon-precomposed" href="./assets/images/logo/favicon.png">
    ...
    <div class="tf-page-cart-item">
        <form>
            <table class="tf-table-page-cart table">
                <thead>
                    <tr>
                        <th>Product</th>
                        <th>Price</th>
                ...
                <tbody>
                    <c:forEach items="${cart}" var="orderItem">
                        <tr class="tf-cart-item">
                            <td class="tf-cart-item_product d-flex align-items-start">
                                <!-- Product Image -->
                                <a href="product-detail.html" class="img-box">
                                    <img src="${orderItem.product.thumbnail}" alt="img-product" class="img-thumbnail" style="width: 70px; height: auto;">
                                </a>
                                <!-- Product Name and Variant -->
                                <div class="cart-info ml-3">
                                    <a href="product-detail.html" class="cart-title link">${orderItem.product.name}</a>
                                    <div class="cart-meta-variant text-muted">White / M</div>
                                   <!-- Remove link -->
                            ...
                            <!-- Price -->
                            <td class="tf-cart-item_price">$${orderItem.price}</td>
                            <!-- Quantity -->
                            <td>
                            <form action="CartServlet" method="post" class="form-inline">
                                ...
                                <div class="input-group">
                                    <!-- Nút Gi?m S? L??ng -->
                                    <button type="submit" class="btn btn-light border" name="quantity" value="${orderItem.quantity - 1}" }>-</button>
                                    <input type="number" name="currentQuantity" value="${orderItem.quantity}" class="form-control text-center" style="width: 50px;" readonly>
                                    <button type="submit" class="btn btn-light border" name="quantity" value="${orderItem.quantity + 1}">+</button>
                                </div>
                            </form>
                        </td>
                        ...
                        <div class="tf-cart-footer-inner">   
                            <div class="tf-page-cart-checkout">                             
                                ...
                                <div class="cart-checkout-btn">
                                    <a href="CheckoutServlet" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                                        <span>Check out</span>
                                    </a>
                                </div>
